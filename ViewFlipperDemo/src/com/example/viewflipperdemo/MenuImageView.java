...
public class MenuImageView extends ImageView {
    ...
    private MenuImageViewActionUpListener listener;

    public MenuImageView(Context context) {
        super(context);
    }

    public interface MenuImageViewActionUpListener {
        void onActionUp(View v);
    }

    public void setListener(MenuImageViewActionUpListener listener) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                if (isReduce) {
                    ...
                    handler.sendEmptyMessage(3);
                    // Log.i("postScale", "恢复");
                    listener.onActionUp(MenuImageView.this);
                }
